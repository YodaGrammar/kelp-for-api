...
class Version20180423201649 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE kelp_product (id INT AUTO_INCREMENT NOT NULL, packaging_id INT NOT NULL, storage_id INT NOT NULL, quantity INT NOT NULL, label VARCHAR(50) NOT NULL, date_peremption DATETIME, date_add DATETIME NOT NULL, is_active TINYINT(1) NOT NULL, INDEX IDX_FACE29814E7B3801 (packaging_id), INDEX IDX_FACE29815CC5DB90 (storage_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
